...
net_io_counters = psutil.net_io_counters(pernic=True)['Ethernet']
print(psutil.net_if_addrs())
#print(psutil.net_if_addrs()['Wi-Fi'][1].address)
#mylcd.lcd_display_string(display_str, 1)
display_str_cpu = \
    'CPU Usage: user {0}%, system {1}%, idle {2}%, interrupt {3}%, dpc {4}% '.format(cpu_times_percent.user, 
